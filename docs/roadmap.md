...
Дата: 2026-09-14. PR-00–PR-09 выполнены; CON-01/TX-01 и проверки предыдущих шагов пройдены на PostgreSQL 17. PR-10–PR-26 — будущие работы; их выполнение требует отдельного запроса на реализацию. Номера обозначают логические шаги, а каждый шаг имеет одну основную цель.
