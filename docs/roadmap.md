...
Дата: 2026-09-16. PR-00–PR-17 выполнены; read-адаптер Яндекса реализован выключенным,
поскольку launch gates YG-01–YG-06 открыты. API-01/OUT-01/OUT-02 и предыдущие проверки
пройдены на PostgreSQL 17. PR-18–PR-26 — будущие работы; их выполнение требует отдельного
