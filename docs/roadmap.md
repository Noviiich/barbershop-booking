...
Дата: 2026-09-16. PR-00–PR-16 выполнены; PR-16 зафиксировал публичный контракт и честно
оставил launch gates YG-01–YG-06 открытыми. API-01/OUT-01/OUT-02 и предыдущие проверки
пройдены на PostgreSQL 17. PR-17–PR-26 — будущие работы; их выполнение требует отдельного
