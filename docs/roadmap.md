...
Дата: 2026-09-14. PR-00–PR-10 выполнены; AVL-01/TIME-01 и проверки предыдущих шагов пройдены на PostgreSQL 17. PR-11–PR-26 — будущие работы; их выполнение требует отдельного запроса на реализацию. Номера обозначают логические шаги, а каждый шаг имеет одну основную цель.
