...
Дата: 2026-09-16. Выполнены PR-00–PR-17, PR-21 и техническая часть PR-22. PR-18–PR-20
сознательно приостановлены до закрытия YG-03/04/05; read-адаптер и все возможности Яндекс
выключены. API-01/OUT-01/OUT-02/OBS-01/SEC-01 и предыдущие проверки пройдены на PostgreSQL
17. Для PR-22 до публичного запуска остаётся owner gate retention-политики. PR-23–PR-26 —
будущие работы; их выполнение требует отдельного запроса на реализацию. Номера обозначают
логические шаги, а каждый шаг имеет одну основную цель.
