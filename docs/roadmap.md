...
Дата: 2026-09-14. PR-00–PR-11 выполнены; LIFE-01/CON-02 и проверки предыдущих шагов пройдены на PostgreSQL 17. PR-12–PR-26 — будущие работы; их выполнение требует отдельного запроса на реализацию. Номера обозначают логические шаги, а каждый шаг имеет одну основную цель.
