...
Дата: 2026-09-16. PR-00–PR-15 выполнены; API-01/OUT-01/OUT-02 и предыдущие проверки пройдены на PostgreSQL 17. PR-16–PR-26 — будущие работы; их выполнение требует отдельного запроса на реализацию. Номера обозначают логические шаги, а каждый шаг имеет одну основную цель.
