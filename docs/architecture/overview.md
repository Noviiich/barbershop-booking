...
Дата: 2026-09-11. Решения приняты как проектная база; выполнены каркас PR-01, identity/policy слой PR-03 и каталог PR-04, PostgreSQL-инфраструктура PR-02 ожидает полного запуска MIG-01 с Docker-доступом. Booking и расписание пока не реализованы. См. [требования](../product/requirements.md) и [ADR](../adr/README.md).
