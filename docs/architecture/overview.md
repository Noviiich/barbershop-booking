...
Дата: 2026-09-11. Решения приняты как проектная база; выполнены каркас PR-01 и identity/policy слой PR-03, PostgreSQL-инфраструктура PR-02 реализована и ожидает полного запуска MIG-01 с Docker-доступом. Бизнес-моделей и доменной логики нет. См. [требования](../product/requirements.md) и [ADR](../adr/README.md).
