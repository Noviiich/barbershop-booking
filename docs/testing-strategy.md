...
Дата: 2026-09-11. Реализованы DOC-01, BOOT-01, AUTH-01 и модели/проверки CAT-01 для PR-04; MIG-01 и DB-часть CAT-01 ожидают Docker-доступ для полного запуска. Остальные тестовые ID и пути ниже — спецификация будущих тестов.
