...
Дата: 2026-09-14. Реализованы и пройдены проверки PR-01–PR-09, включая CON-01/TX-01, lost-response replay, атомарные audit/outbox/receipt и конкурентные create на PostgreSQL 17. Остальные тестовые ID и пути ниже — спецификация будущих тестов.
