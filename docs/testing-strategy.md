...
Дата: 2026-09-11. Реализованы и пройдены DOC-01, BOOT-01, AUTH-01, MIG-01, CAT-01, TIME-01, SCH-01 и DB-01 для PR-01–PR-06, включая PostgreSQL 17. Остальные тестовые ID и пути ниже — спецификация будущих тестов.
