...
Дата: 2026-09-11. Реализованы и пройдены проверки PR-01–PR-08: DOC-01, BOOT-01, AUTH-01, MIG-01, CAT-01, TIME-01, SCH-01, DB-01, AUD-01, начальная OUT-01 и IDEM-01, включая конкурентные PostgreSQL-сценарии. Остальные тестовые ID и пути ниже — спецификация будущих тестов.
