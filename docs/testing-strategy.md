...
Дата: 2026-09-11. Реализованы DOC-01, BOOT-01 и AUTH-01; код/тест MIG-01 для PR-02 ожидает Docker-доступ для полного запуска. Остальные тестовые ID и пути ниже — спецификация будущих тестов, а не уже работающий suite. ORM-модели предметной области и доменная логика на этом этапе не создаются.
