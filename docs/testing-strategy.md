...
Дата: 2026-09-11. Реализованы DOC-01, BOOT-01, AUTH-01, CAT-01 и unit-часть TIME-01/SCH-01 для PR-05; DB-проверки MIG-01/CAT-01/SCH-01 ожидают Docker-доступ для полного запуска. Остальные тестовые ID и пути ниже — спецификация будущих тестов.
